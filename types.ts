...
let engine: number; //will always be a number
...
let sweets2: any[] = ['cake', 'ice cream', 'cookies']; //array of any type
let sweets3: any = ['cake', 'ice cream', 'cookies']; //any type
...
function cal2(val1:number, val2:number){
